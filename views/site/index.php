...
$this->title = 'Catsowner - CZN Token';
?>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-7 col-md-7 col-sm-12">
							<p>Development of a desktop application for Windows, Android Wallet. Connecting Sidechain + Secure Sandbox. Opportunity to create decentralized applications on the CZN platform.</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="roadmap-item-full" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.3s">
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-7 col-md-7 col-sm-12">
							<p>Placement of Cat`s owner on exchanges. The list of exchanges that placed CZN will be constantly updated, please, kindly check our site.</p>
						</div>
					</div>
				</div>
			</div>
							...
							<div class="card-header" id="faqHeading-4">
								<div class="mb-0">
									<h5 class="faq-title" data-toggle="collapse" data-target="#faqCollapse-4" data-aria-expanded="false" data-aria-controls="faqCollapse-4">
										<span class="badge">4</span> Why should I use CZN currency and how is it different from other currencies?
									</h5>
								</div>
							</div>
							...
							<div class="card-header" id="faqHeading-5">
								<div class="mb-0">
									<h5 class="faq-title" data-toggle="collapse" data-target="#faqCollapse-5" data-aria-expanded="false" data-aria-controls="faqCollapse-5">
										<span class="badge">5</span> How is CZN and Cat`s owner helping entrepreneurs?
									</h5>
								</div>
							</div>
							...
							<div class="card-header" id="faqHeading-6">
								<div class="mb-0">
									<h5 class="faq-title" data-toggle="collapse" data-target="#faqCollapse-6" data-aria-expanded="false" data-aria-controls="faqCollapse-6">
										<span class="badge">6</span> What benefits can I get from joining the CZN crowd funding platform?
									</h5>
								</div>
							</div>
							...
							<div class="card-header" id="faqHeading-7">
								<div class="mb-0">
									<h5 class="faq-title" data-toggle="collapse" data-target="#faqCollapse-7" data-aria-expanded="false" data-aria-controls="faqCollapse-7">
										<span class="badge">7</span> How do I convert my CZN currency into US dollars or other currencies?
									</h5>
								</div>
							</div>
